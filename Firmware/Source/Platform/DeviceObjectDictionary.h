...
//
#define REG_OVERRIDE_ADC_REF			53	// Переопределение опорного напряжения АЦП
#define REG_INVERT_SCOPE_SYNC			54	// Инверсия выхода осциллографа
#define REG_OVERRIDE_DAC_REF			55	// Переопределение опорного напряжения ЦАП
// 56 - 59
...
#define REG_SHORT_CALIBRATE_FLAG		132	// Флаг проведения калибровки с КЗ на выходе
...
//
#define REG_DIAG_ANODE_SHORT			207	// Диагностические данные c ацп при проверке на кз
