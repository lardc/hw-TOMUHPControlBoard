...
//
#define REG_GD_I_FALL_RATE_K			25	// Пересчёт скорости спада тока в значение ЦАП пропорциональный коэффициент
#define REG_GD_I_FALL_RATE_OFFSET		26	// Пересчёт скорости спада тока в значение ЦАП смещение
//
...
//
#define REG_U_DUT_600V_K				50	// Коэффициент подстройки напряжения для 600В
#define REG_U_DUT_1000V_K				51	// Коэффициент подстройки напряжения для 1000В
#define REG_U_DUT_1500V_K				52	// Коэффициент подстройки напряжения для 1500В
// 53 - 127
