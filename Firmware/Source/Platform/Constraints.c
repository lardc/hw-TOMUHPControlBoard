...
const TableItemConstraint NVConstraint[DATA_TABLE_NV_SIZE] =
{
	...
	{DUT_CURRENT_MIN, DUT_CURRENT_MAX, DUT_CURRENT_DEF},						// 4
	...
	{0, INT16U_MAX, 0},															// 51
	{0, INT16U_MAX, 0},															// 52
	{REF_ADC_VOLTAGE_MIN, REF_ADC_VOLTAGE_MAX, REF_ADC_VOLTAGE_DEF},			// 53
	{0, 1, 0},																	// 54
	{REF_DAC_VOLTAGE_MIN, REF_DAC_VOLTAGE_MAX, REF_DAC_VOLTAGE_DEF},			// 55
	{0, 0, 0},																	// 56
	{0, 0, 0},																	// 57
	{0, 0, 0},																	// 58
	{0, 0, 0},																	// 59
	...
	{0, 0, 0},																	// 83
	{ID_THRESHOLD_MIN, ID_THRESHOLD_MAX, ID_THRESHOLD_DEF},					 	// 84
	{AFTER_MEASURE_DELAY_MIN, AFTER_MEASURE_DELAY_MAX, AFTER_MEASURE_DELAY_DEF},// 85
	{0, INT16U_MAX, 0},															// 86
	{GAIN_COEFFICIENT_MIN, GAIN_COEFFICIENT_MAX, GAIN_COEFFICIENT_DEF},			// 87
	{0, INT16U_MAX, 0},															// 88
	{0, 0, 0},																	// 89
	{0, INT16U_MAX, 0},															// 90
	{0, INT16U_MAX, 0},															// 91
